...
def readMovies():
    csvfile = open('/Users/grei/Workspace/Learn/learning-elasticsearch/Section_04/downloads/ml-latest-small/movies.csv', 'r')
...
def readRatings():
    csvfile = open('/Users/grei/Workspace/Learn/learning-elasticsearch/Section_04/downloads/ml-latest-small/tags.csv', 'r')
